...
<li><strong>1. Welcoming Customers with Empathy (Onboarding Throughput):</strong> Identity verification can feel unfamiliar for beginners in regulated finance. By offering gentle 3-minute checklists and transparent reassurance, we help users feel safe, supported, and confident from their very first day.</li>
...
<li><strong>3. Honoring the Customer's Actual Goals (Portfolio Personalization):</strong> Every investor's journey is unique. By listening to what customers tell us and observing what they hold, we ensure every message is genuinely helpful, respectful of their time, and aligned with their financial aspirations.</li>
</ul>
...
<strong style="color:#0369a1; font-size:0.96rem;">💡 Where I Focused First: The Video-Ident Drop-Off</strong>
...
• <strong>Isolate the variable:</strong> In production, I test the Subject Line first, then test the CTA copy and market card to isolate which lever drives the biggest lift.<br>
...
<strong>2. What I Did (CRM Campaign):</strong> Instead of telling them to "Trade Today", our automated lifecycle emails & in-app nudges pitch <strong>Automated Monthly Sparplans (DCA) from €25/month</strong> right on European payday (1st of each month).<br>
...
""", unsafe_allow_html=True)
    ...
    st.markdown("#### ✉️ The Automated CRM Campaign I Deployed:")
